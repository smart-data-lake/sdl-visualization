...
export function createPropertiesComponent(props: {obj?: any, properties?: {key: string, value: any}[], propsToIgnore?: string[], colHeader?: string, width?: string, rowHeight?: string}): JSX.Element | undefined {
  ...
  if (entries.length > 0) return <PropertiesComponent entries={entries} width={props.width} rowHeight={props.rowHeight} colHeader={props.colHeader} />;
}
 ...
 */
export default function PropertiesComponent(props: {entries: {key: string, value: any}[], colHeader?: string, width?: string, rowHeight?: string}){
